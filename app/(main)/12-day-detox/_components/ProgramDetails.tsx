            ...
            >
              ...
              <div className="w-full lg:w-1/2">
                <div className="relative group">
                  <div
                    className={`absolute -inset-4 bg-gray-100 dark:bg-gray-800 rounded-3xl opacity-30 group-hover:opacity-50 transition-opacity duration-500 transform rotate-1`}
                  ></div>
                  <Image
                    src={feature.gifUrl}
                    alt={feature.title}
              ...
              <div className="w-full lg:w-1/2">
                <div className="max-w-lg">
                  ...
                  <div className="flex items-center gap-4 mb-8">
                    <div
                      className={`w-16 h-16 bg-${feature.shade} dark:bg-gray-700 rounded-2xl flex items-center justify-center shadow-lg hover:bg-green-500 dark:hover:bg-green-600 transition-colors duration-300`}
                    >
                      <span className="text-2xl">{feature.icon}</span>
                    </div>
                    <div className="text-sm font-bold text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full">
                      {String(index + 1).padStart(2, "0")}
                    </div>
                  </div>

                  <h3 className="text-2xl lg:text-3xl font-bold text-black dark:text-white mb-6 leading-tight">
                    {feature.title}
                  </h3>
                  ...
                  <div className="flex items-center">
                    <div
                      className={`w-8 h-8 bg-${feature.shade} dark:bg-gray-700 rounded-full flex items-center justify-center mr-4 flex-shrink-0 hover:bg-green-500 dark:hover:bg-green-600 transition-colors duration-300`}
                    >
